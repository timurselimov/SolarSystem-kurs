...
int main() {
	...
	/* SPHERE GENERATION */
	Sphere —ÓÎÌˆÂ(100.0f, 36 * 5, 18 * 5);
	Sphere ÃÂÍÛËÈ(10.0f, 36, 18);
	Sphere ¬ÂÌÂ‡(12.0f, 36, 18);
	Sphere «ÂÏÎˇ(11.8f, 36, 18);
	Sphere Ã‡Ò(8.0f, 36, 18);
	Sphere ﬁÔËÚÂ(40.0f, 36, 18);
	Sphere —‡ÚÛÌ(37.0f, 36, 18);
	Sphere ”‡Ì(30.0f, 36, 18);
	Sphere ÕÂÔÚÛÌ(30.0f, 36, 19);
	Sphere ÀÛÌ‡(5.5f, 36, 18);
	/* SPHERE GENERATION */
...
void ShowInfo(Shader &s)
{
	RenderText(s, "Planeta: " + Info.Name, 25.0f, SCREEN_HEIGHT - 30.0f, 0.35f, glm::vec3(0.7f, 0.7f, 0.11f));
	RenderText(s, "Sredniya orbitalnaiya skorost (km/s): " + Info.OrbitSpeed, 25.0f, SCREEN_HEIGHT - 50.0f, 0.35f, glm::vec3(0.7f, 0.7f, 0.11f));
	RenderText(s, "Massa (kg * 10^24): " + Info.Mass, 25.0f, SCREEN_HEIGHT - 70.0f, 0.35f, glm::vec3(0.7f, 0.7f, 0.11f));
	RenderText(s, "Gravitasya (g): " + Info.Gravity, 25.0f, SCREEN_HEIGHT - 90.0f, 0.35f, glm::vec3(0.7f, 0.7f, 0.11f));
}